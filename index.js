...
const port = process.env.PORT || 9090;
  ...
  let up = `*↪ Hello, DML-MD Legend! ⤵*

╭─〔 *🚨 DML-MD BOT* 〕  
├─▸ *Simplicity. Speed. Power. by bmb xmd|*  
...
╭──〔 🔗 *Quick Links* 〕  
├─ 📢 *Join Our Channel:*  
│   Click [**Here**](https://whatsapp.com/channel/0029Vb2hoPpDZ4Lb3mSkVI3C) to join!  
├─ ⭐ *Give Us a Star:*  
│   Star Us [**Here**](https://github.com/MLILA17/DML-MD)!  
╰─🛠️ *Prefix:* \`${prefix}\`
...
> _© MADE BY DML-MD_`;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('255713541112', '255622220780', '255785591288');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.inclueds("255622220680")){
  if(isReact) return
  m.react( )
   }
  //==========public react============//
